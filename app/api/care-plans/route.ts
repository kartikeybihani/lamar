...
Be concise but clinically specific.

**4. Monitoring Plan & Lab Schedule**  
Summarize what parameters will be tracked, frequency, and follow-up requirements (vitals, labs, symptoms, infusion reactions, renal function, etc.).
...
// Generate care plan text using OpenRouter AI
const generateCarePlanText = async (formData: CarePlanFormData): Promise<string> => {
  ...
  try {
    console.log('Calling OpenRouter API for care plan generation...');
    ...
    console.log('Successfully generated care plan via OpenRouter API');
